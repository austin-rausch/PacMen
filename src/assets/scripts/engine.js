...
Pacman.prototype = {
    ...
    preload: function () {
        ...
        this.load.tilemap('map', 'assets/sprites/pacman-map.json', null, Phaser.Tilemap.TILED_JSON);
    },
    ...
    update: function () {
        ...
        var x = this.math.snapToFloor(Math.floor(this.pacman.x), this.gridsize) / this.gridsize;
        var y = this.math.snapToFloor(Math.floor(this.pacman.y), this.gridsize) / this.gridsize;
